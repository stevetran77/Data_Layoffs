...
-- Step 1 :Create the staging data for cleaning
...
-- 3. Remove comma after country_name
...
-- 4. Change the type of date column from text to date_time
...
-- Remove rows which have null total & percentage laid off 
SELECT * 
FROM layoffs_staging2
